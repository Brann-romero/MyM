    ...
    <nav class="site-nav">
      ...
      <div class="nav-dropdown">
        ...
        <div class="nav-dropdown__menu">
          ...
          <button onclick="navigate('productos','estampados')">Remeras, Buzos y Camperas</button>
          <button onclick="navigate('productos','remera-lisas')">Remera Lisa</button>
          ...
          <button onclick="navigate('productos','letras-corporia')">Letras Corporea</button>
    ...
    <div class="footer-top">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a onclick="navigate('productos','estampados')">Remeras, Buzos y Camperas</a></li>
          <li><a onclick="navigate('productos','remera-lisas')">Remera Lisa</a></li>
          ...
          <li><a onclick="navigate('productos','letras-corporia')">Letras Corporea</a></li>
